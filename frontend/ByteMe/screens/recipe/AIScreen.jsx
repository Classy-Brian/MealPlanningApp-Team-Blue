...
const localStyles = StyleSheet.create({
  ...
  mealCard: { width: '32%', backgroundColor: '#f8f9fa', borderRadius: 12, elevation: 5, alignItems: 'center', marginBottom: 10 },
  mealImage: {
    width: '100%',
    height: undefined,
    aspectRatio: 0.75, // Or use 4/3 or 16/9
    borderTopLeftRadius: 12,
    borderTopRightRadius: 12,
    backgroundColor: '#f0f0f0',
  },
  
  mealLabel: { fontSize: 14, fontWeight: 'bold', marginVertical: 5 },
