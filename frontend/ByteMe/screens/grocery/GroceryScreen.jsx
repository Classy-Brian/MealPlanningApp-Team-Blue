  ...
  const GroceryScreen = () => {
    ...
    const fetchSavedGrocery = async () => {
        ...
        try {
          ...
          console.log("Grocery API response:", response.data); // temp log:: remove
          ...
          // Group data like in the pantry screen
    ...
    // For Grocery, the floating add button should navigate directly to the AddGroceryIngredientScreen.
    ...
    return (
      <View style={styles.whiteBackground}>
        ...
        <Animated.View style={[det.buttonContainer1, animatedStyle]}>
          <TouchableOpacity onPress={handleAddGrocery}>
            <View style={det.addContainer}>
              <View style={[det.button, { marginRight: 10 }]}>
                <Text style={[styles.regText16, { fontFamily: fonts.medium }]}>
                  Add From Search
                </Text>
              </View>
